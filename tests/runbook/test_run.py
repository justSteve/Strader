...
@pytest.mark.skipif(shutil.which("marked") is None, reason="marked not on PATH")
...
def test_desk_html_absent_marked_is_non_fatal(monkeypatch, _isolate_desk, tmp_path):
