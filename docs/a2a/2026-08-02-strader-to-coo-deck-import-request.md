...
4. `gc mail send coo` failed ("session not found") — hence this file. Same failure class as the st-cy1 WaitDelay memo's cold-start finding, flagging in case it's related.
